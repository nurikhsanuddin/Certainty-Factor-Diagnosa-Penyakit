...
elseif ($mod == 'diagnosa_tambah') {
    ...
    elseif ($db->get_row("SELECT * FROM tb_diagnosa WHERE kode_diagnosa='$kode'"))
        ...
        $db->query("INSERT INTO tb_diagnosa (kode_diagnosa, nama_diagnosa, keterangan, gambar) VALUES ('$kode', '$nama', '$keterangan','$gambar')");
    ...
    if ($kode == '' || $nama == '')
        ...
        $db->query("UPDATE tb_diagnosa SET nama_diagnosa='$nama', keterangan='$keterangan', gambar='$gambar' WHERE kode_diagnosa='$_GET[ID]'");
        redirect_js("index.php?m=diagnosa");
    }
...
/** relasi */
    ...
    if ($_POST['jawaban']) {
        ...
        $db->query("INSERT INTO tb_konsultasi (kode_gejala, jawaban) VALUES ('$kode_gejala', '$jawaban')");
    } elseif ($act == 'new') {
