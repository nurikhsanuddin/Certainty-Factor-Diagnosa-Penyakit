    ...
    <div class="col-sm-6">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode" value="<?= set_value('kode', kode_oto('kode_diagnosa', 'tb_diagnosa', 'P', 1)) ?>" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Link Gambar <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="gambar" value="<?= set_value('gambar') ?>" />
            </div>
            <div class="form-group">
