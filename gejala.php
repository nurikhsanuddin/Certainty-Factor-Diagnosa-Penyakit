    ...
    <div class="panel-heading">
        <form class="form-inline">
            ...
            <div class="row my-3">
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        <a class="btn w-100 btn-primary" href="?m=gejala_tambah"><span>
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        <a class="btn w-100 btn-primary" href="cetak.php?m=gejala" target="_blank"><span>
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            foreach ($rows as $row) : ?>
                <tr>
                    ...
                    <td class="nw">
                        <a class="btn btn-sm w-100 m-1 btn-warning" href="?m=gejala_ubah&ID=<?= $row->kode_gejala ?>"><span class="glyphicon glyphicon-edit">Edit</span></a>
                        <a class="btn btn-sm w-100 m-1 btn-danger" href="aksi.php?act=gejala_hapus&ID=<?= $row->kode_gejala ?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash">Hapus</span></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
